...
/**
 * The {@code LookupSubjectsResultBody} class holds all the fields in a single element in a results stream returned
 * from a lookup subject request.
 */
public class LookupSubjectsResultBody {

    @SerializedName(SpiceDbModelConstants.LOOKED_AT)
    @Expose
    private ZedToken lookedAt;
    @SerializedName(SpiceDbModelConstants.SUBJECT_ID)
    @Expose
